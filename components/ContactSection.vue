    ...
    <div class="container">
      <div class="text-center mb-16">
        <span class="section-label"
          ><span class="glow-line" />Get In Touch</span
        >
      ...
      <div class="grid lg:grid-cols-6 justify-center gap-12 max-w-5xl mx-auto">
        <!-- Contact Info -->
        <div class="lg:col-span-1"></div>
        <div class="glass-card lg:col-span-4 p-8 space-y-6">
          ...
          <div class="space-y-4">
            ...
            >
              <div
                class="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 transition-all duration-200 group-hover:border-primary/30 group-hover:bg-primary/10"
              ...
              <div>
                ...
                <p
                  class="text-sm font-semibold group-hover:text-primary transition-colors duration-200"
...
const contactLinks = [
  {
    label: "Email",
    value: "naybala.personal@gmail.com",
