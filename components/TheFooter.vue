    ...
    <div class="container">
        ...
        <nav aria-label="Footer navigation">
          <ul class="flex flex-wrap justify-center gap-x-6 gap-y-2">
            <li v-for="link in footerLinks" :key="link">
              <button
                class="text-sm hover:text-primary transition-colors duration-200 cursor-pointer animated-underline"
      ...
      >
        ...
        >
          ...
          <span style="color: var(--color-text-muted)">GSAP</span>
        </p>
      </div>
    </div>
  </footer>
