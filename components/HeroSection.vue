  ...
  >
    ...
    <div class="container relative z-20 py-24 lg:py-32">
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div
          ref="leftContentRef"
          class="flex flex-col items-center lg:items-start text-center lg:text-left order-2 lg:order-1 mt-8 lg:mt-0"
        >
          <!-- Badge -->
          <div
            class="reveal-up inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/20 bg-primary/5 text-primary text-sm font-mono mb-8"
          >
          ...
          <h1 class="reveal-up font-black tracking-tight leading-[1.05] mb-5">
            <span
              class="block text-xl sm:text-2xl font-semibold font-mono mb-3 tracking-widest"
              style="color: var(--color-text-muted)"
            >
              Hello, I'm
            </span>
            <span
              class="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl gradient-text"
            >
              Nay Ba La
            </span>
          </h1>
          ...
          <!-- Role -->
          <p
            class="reveal-up text-xl sm:text-2xl font-semibold mb-4"
          ...
          <!-- Typing -->
          <div
            class="reveal-up flex items-center justify-center lg:justify-start gap-2 text-base sm:text-lg mb-10 h-8"
            style="color: var(--color-text-muted)"
          >
          ...
          <!-- CTA -->
          <div
            class="reveal-up flex flex-wrap justify-center lg:justify-start items-center gap-4 mb-10"
          >
            ...
            <a
              href="https://drive.google.com/file/d/19FlE8LaVo5NQ59y60DSn0B3-Ya2t01E0/view?usp=sharing"
              target="_blank"
              download
          ...
          <!-- Socials -->
          <div
            class="reveal-up flex flex-wrap justify-center lg:justify-start items-center gap-3"
          >
            <a
            ...
            <span
              class="hidden sm:block w-px h-6 bg-white/10"
              aria-hidden="true"
              :style="{ background: 'var(--color-border)' }"
            />
            <div
              class="flex items-center gap-4 text-xs font-mono w-full sm:w-auto justify-center sm:justify-start mt-2 sm:mt-0"
              style="color: var(--color-text-muted)"
            >
              <span><span class="text-primary font-bold">4+</span> yrs</span>
              <span
                ><span class="text-primary font-bold">20+</span> projects</span
              >
            </div>
          </div>
        </div>
        ...
        <div
          ref="rightContentRef"
          class="reveal-right flex items-center justify-center lg:justify-end order-1 lg:order-2"
        >
          <div class="relative">
            <!-- Outer rings -->
            <div
            ...
            <div
              ref="photoRef"
              class="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden"
            >
              <div
              ...
              <img
                src="/myProfile.png"
                alt="Nay Ba La — Full Stack Web Developer"
            ...
            <!-- Floating badges -->
            <div
              class="absolute bottom-4 -right-4 flex items-center gap-2 px-3 py-2 rounded-xl glass-card shadow-glow-primary"
            >
              <span
                class="w-2 h-2 rounded-full bg-accent animate-pulse flex-shrink-0"
              />
              <span
    ...
    >
      <span>scroll</span>
      <div
        class="w-px h-12 bg-gradient-to-b from-primary/50 to-transparent animate-pulse"
      />
    </div>
  </section>
</template>
...
const floatingTechs = [
  ...
  },
  {
    ...
    style: {
      top: "22%",
      right: "4%",
      animation: "float 8.5s ease-in-out 1.8s infinite",
    },
  },
  {
    name: "Vue.js",
  ...
  },
  {
    ...
    style: {
      top: "70%",
      right: "8%",
      animation: "float 9.5s ease-in-out 0.3s infinite",
    },
  },
  {
    name: "PostgreSQL",
    ...
    style: {
      top: "38%",
      right: "2%",
      animation: "float 7.2s ease-in-out 2.2s infinite",
    },
  },
  {
    name: "Docker",
  ...
  },
  {
    ...
    style: {
      top: "92%",
      right: "35%",
      animation: "float 8.8s ease-in-out 2.8s infinite",
    },
  },
];
