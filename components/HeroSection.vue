      ...
      <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div ref="leftContentRef" class="flex flex-col items-center lg:items-start text-center lg:text-left order-2 lg:order-1 mt-8 lg:mt-0">
          ...
          <h1 class="reveal-up font-black tracking-tight leading-[1.05] mb-5">
            <span class="block text-xl sm:text-2xl font-semibold font-mono mb-3 tracking-widest" style="color: var(--color-text-muted)">
              Hello, I'm
            </span>
          ...
          <!-- Role -->
          <p class="reveal-up text-xl sm:text-2xl font-semibold mb-4" style="color: var(--color-text)">
          ...
          <div class="reveal-up flex flex-wrap justify-center lg:justify-start items-center gap-4 mb-10">
            ...
            <a href="/resume.pdf" download class="btn-outline magnetic" aria-label="Download Resume PDF">
              <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div class="relative">
            ...
            <div ref="photoRef" class="relative w-64 h-64 sm:w-80 sm:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden">
              ...
              <div
                ...
                aria-hidden="true"
              >
                <div class="w-full h-full rounded-full" style="background: var(--color-bg)" />
              </div>
              <!-- Photo -->
              <img
                src="/myProfile.png"
            ...
            <!-- Floating badges -->
            <div class="absolute bottom-4 -right-4 flex items-center gap-2 px-3 py-2 rounded-xl glass-card shadow-glow-primary">
              <span class="w-2 h-2 rounded-full bg-accent animate-pulse flex-shrink-0" />
              <span class="text-xs font-semibold whitespace-nowrap" style="color: var(--color-text)">Open to work</span>
            </div>
            <div class="absolute -top-2 -left-6 flex items-center gap-1.5 px-3 py-2 rounded-xl glass-card">
              <span class="text-primary text-xs font-mono font-bold">4+</span>
              <span class="text-xs" style="color: var(--color-text-muted)">Years Exp.</span>
            </div>
          </div>
        </div>
