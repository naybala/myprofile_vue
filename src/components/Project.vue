                        ...
                        <div class="card">
                            ...
                            <div class="contentBx">
                                ...
                                <div class="color mt-1 mb-1">
                                    ...
                                    <p class="text-white" style="margin-top: 0.5rem;">JavaScript</p>
                                </div>
                                <a
                    ...
                    <div class="col-md-4 py-3" id="col">
                        <div class="card">
                            ...
                            <div class="contentBx">
                                ...
                                <div class="color mt-1 mb-1">
                                    <h3 class="">Type of Wesbsite :</h3>
                                    <p class="text-white" style="margin-top: 0.5rem;">Simple</p>
                                </div>
                                <a
                    ...
                    <div class="col-md-4 py-3" id="col">
                        <div class="card">
                            ...
                            <div class="contentBx">
                                ...
                                <div class="color mt-1 mb-1">
                                    <h3 class="">Type of Wesbsite :</h3>
                                    <p class="text-white" style="margin-top: 0.5rem;">Full-Stack</p>
                                </div>
